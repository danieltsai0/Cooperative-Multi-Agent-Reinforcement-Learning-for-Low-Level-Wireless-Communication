...
class NeuralTransmitter(object):
    def __init__(self, n_bits=2, n_hidden=32, steps_per_episode=32, stepsize=5e-3):
        self.n_bits = n_bits
...
if __name__ == '__main__':
    ...
    qam16 = {
        ...
        (0, 0, 0, 1): 1.0/np.sqrt(2)*np.array([3, 1]),
        (0, 0, 1, 0): 1.0/np.sqrt(2)*np.array([1, 3]),
        (0, 0, 1, 1): 1.0/np.sqrt(2)*np.array([3, 3]),
        (0, 1, 0, 0): 1.0/np.sqrt(2)*np.array([1, -1]),
        (0, 1, 0, 1): 1.0/np.sqrt(2)*np.array([1, -3]),
        (0, 1, 1, 0): 1.0/np.sqrt(2)*np.array([3, -1]),
        (0, 1, 1, 1): 1.0/np.sqrt(2)*np.array([3, -3]),
        (1, 0, 0, 0): 1.0/np.sqrt(2)*np.array([-1, 1]),
        (1, 0, 0, 1): 1.0/np.sqrt(2)*np.array([-1, 3]),
        (1, 0, 1, 0): 1.0/np.sqrt(2)*np.array([-3, 1]),
        (1, 0, 1, 1): 1.0/np.sqrt(2)*np.array([-3, 3]),
        (1, 1, 0, 0): 1.0/np.sqrt(2)*np.array([-1, -1]),
        (1, 1, 0, 1): 1.0/np.sqrt(2)*np.array([-3, -1]),
        (1, 1, 1, 0): 1.0/np.sqrt(2)*np.array([-1, -3]),
        (1, 1, 1, 1): 1.0/np.sqrt(2)*np.array([-3, -3])
    }
