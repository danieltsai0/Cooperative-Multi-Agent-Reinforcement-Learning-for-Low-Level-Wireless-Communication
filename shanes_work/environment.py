############################################################
#
#  Basic Modulation Environment Simulator
#  Shane Barratt <stbarratt@gmail.com>
#
#  Simulates a communication environment.
#
############################################################
...
class Environment(object):
    ...
    def __init__(self, n_bits = 4, l = .01, sigma = 0.2):
        self.n_bits = n_bits
        self.state = 0
        self.l = l
        self.noise = lambda x: x + np.random.normal(loc=0.0, scale=sigma, size=2)
